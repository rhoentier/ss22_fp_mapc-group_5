...
/**
 * Interne Karte zum Speichern bisher wahrgenommener Dinge wie z.B. Hindernisse,
 * Dispenser, Goal- oder Role-Zones.
 *
...
public class NextMap {
     ...
     *
     * @param agentPosition Position of the agent relative to the upper left
     * corner
     * @param percept HashSet of NextMapTiles with local position (relative to
     * the agents position)
     */
    ...
    /**
     * Returns a Vector2D-object with the highest map-value in x- and
     * y-direction.
     *
     * @return
     */
    ...
    /**
     * Returns a map tile at a given position (possible values are obstacle,
     * free or unknown) Dispensers, GoalZones and RoleZones are not considered!
     *
     * @param position
    ...
    /**
     * Checks if a given list of block types is already known (... or the
     * dispensers to get the blocks from). Only results in true, if min 1
     * goalZone is known, too.
     *
    ...
    /**
     * Returns the map with unknown, free or obstacle - maptiles (dispenser,
     * goalZones, roleZones are not considered)
     *
     * @return map object
     */
    ...
    /**
     * Updates the group map with the information of a single agent in each
     * step. The update includes the movement of the agent as well as the
     * received percept.
     *
    ...
    /**
     * Analyze the most negative value in x- and y-direction. Shift all maptiles
     * and agents with this offset to be at minimum at position 0/0.
     */
    ...
    /**
     * Generates a HashSet of Vector2D with all positions inside the view
     * (diamond-shape)
     *
     * @param vision vision range
     * @param includeCenter boolean to define if 0/0 should be included as
     * Vector2D
     * @return
     */
    ...
    /**
     * Analyze the hashSet of dispensers and update the list of available
     * dispenser types.
     */
