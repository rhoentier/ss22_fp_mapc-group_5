    ...
    public Action step() {
        ...
        try{
            ...
            */
            ...
            aStarMemory = aStar.calculatePath(agentStatus.getMap().getMapArray(), agentStatus.getPosition().getSubtracted(agentStatus.getPosition()), agentStatus.getPosition().getSubtracted(agentStatus.getPosition()).getAdded(2, 4) );
