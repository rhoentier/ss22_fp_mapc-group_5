...
public final class NextAgentUtil {
    ...
    public static Action GenerateSurveyThingAction(String type) {
        return NextActionWrapper.CreateAction(NextConstants.EActions.SURVEY, new Identifier(type));
    }
    ...
    public static Action GenerateSurveyAgentAction(int xPosition, int yPosition) {
        return NextActionWrapper.CreateAction(NextConstants.EActions.SURVEY, new Identifier("" + xPosition), new Identifier("" + yPosition));
    }
}