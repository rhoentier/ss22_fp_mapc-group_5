...
Start-Process -FilePath java -ArgumentList '-jar .\massim_2022\javaagents\target\javaagents-2022-1.1-jar-with-dependencies.jar .\massim_2022\javaagents\conf\NextMiri'
